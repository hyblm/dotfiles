...
keyboardlayout.country_code_flag = {
    ["ad"] = "\u{1f1e6}\u{1f1e9}",    -- Andorra
    ["af"] = "\u{1f1e6}\u{1f1eb}",    -- Afganistan
    ["al"] = "\u{1f1e6}\u{1f1f1}",    -- Albania
    ["am"] = "\u{1f1e6}\u{1f1f2}",    -- Armenia
    ["ara"] = "\u{1f1f8}\u{1f1e6}",   -- Arabic (SA - Saudi Arabia)
    ["at"] = true,    -- Austria
    ["az"] = true,    -- Azerbaijan
    ["ba"] = true,    -- Bosnia and Herzegovina
    ["bd"] = true,    -- Bangladesh
...
function keyboardlayout.new()
    ...
    self.layout_name = function(v)
        local name = v.file
        name = " " .. keyboardlayout.country_code_flag[name]
        return name
    end
